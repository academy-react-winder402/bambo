    ...
    return (
        <div className="bg-[#ededed] dark:bg-[#242424ed]">
            ...
            <div className="h-[6rem] w-full flex justify-between ">
                ...
                <h1 className="text-4xl inline-block mr-[4.5rem] mt-[1.5rem] dark:text-white"> دوره های آموزشی </h1>
            ...
            <div className="  mt-[3rem] flex justify-between">
                ...
                <div className=" w-[70rem] ml-[5rem] ">
                    ...
                    <div className={page === 1 ? "flex flex-wrap" : "hidden"}>
                        {
                            course.courseFilterDtos?.map((item, index) => {
                                return (<Item key={index} im={item.tumbImageAddress} title={item.title} modares={item.teacherName} 
                                    price={item.cost} showmodal={() => {setshowModal(true)}}  />);
                            })
                        }
                    ...
                    <div className={page === 2 ? "flex flex-wrap" : "hidden"}>
                        {
                            course.courseFilterDtos?.map((item, index) => {
                                return (<Item2 key={index} im={item.tumbImageAddress} title={item.title} modares={item.teacherName} 
                                    price={item.cost}   />);
                            })
                        }
                    </div>
