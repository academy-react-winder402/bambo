...
const DarkModeSwitch = () =>{
    ...
    return(
        <div onClick={toggleSwitch} className={`flex-start flex h-[40px] w-[80px] rounded-[50px] bg-zinc-100 p-[5px] shadow-inner hover:cursor-pointer dark:bg-zinc-700 ${ isOn && 'place-content-end'}`}>
