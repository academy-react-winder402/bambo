...
">
    ...
    xs:h-[50px]  xs:mt-[0px]  xs:text-[28px] xs:text-black xs:leading-[25px] xs:py-[20px] xs:text-right xs:pr-[40px]
    xs:flex
    ">ورود کاربر 
    <img src={home} onClick={gotohome} className="lg:hidden sm:hidden xs:w-[30px] h-[30px] xs:mr-[150px] cursor-pointer"></img>
    </div>
   ...
   xs:h-[200px] xs:border-solid xs:border-[transparent] xs:border-[1px]
    ...
    ">
        <Formik>
            <Form>
               ...
               xs:h-[150px] xs:w-[350px] xs:mt-[30px] xs:flex xs:flex-col xs:gap-[50px] xs:m-auto
