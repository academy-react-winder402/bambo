...
const ForgotPassPageTwo = ({ step,  phoneNumber }) => {
  ...
  const onSubmit = async () => {
    ...
    console.log(forgotapitwo);
    if (forgotapitwo.success == true) {
      step();
    }
  };
  return (
    <div>
      <Formik validationSchema={Validationthree}>
        <Form>
          <div
            className="lg:h-[200px]   lg:flex flex-col lg:gap-[30px] lg:mt-[50px]
          ...
          >
            ...
            <div
              className="lg:flex lg:gap-[15px] sm:flex sm:gap-[15px] xs:flex xs:gap-[15px] lg:w-[88%] lg:mt-[20px] lg:mx-[5px]
                        sm:mt-[20px] sm:mx-[22px]  md:mt-[20px] md:mx-[30px] xs:mt-[20px] xs:mx-[5px]
                        "
            >
              <Field
                name="code"
                className="lg:w-[100%] lg:h-[50px] lg:rounded-[10px] 
