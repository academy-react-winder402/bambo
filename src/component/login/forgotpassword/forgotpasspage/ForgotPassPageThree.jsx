...
const ForgotPassPageThree= ({setNewpassword}) => {
  const onSubmit = async (values) => {
         
    const obj = {password:values.password, resetpass:values.resetpass };
    const newpassapi = await Postnewpass(obj);
    setNewpassword( newpassapi);
    ...
    return(
      <div >
      <Formik
      initialValues={{password:"",resetpass:""}}
      ...
      >
        <Form>
          ...
          <div className="lg:h-[100px]   lg:flex  lg:flex-col  lg:gap-[10px] 
            ...
            <Field type="password" name="password" className=" lg:w-[88%]  lg:h-[50px]  lg:rounded-[10px] 
          ...
          <div className=" lg:h-[100px]   lg:flex  lg:flex-col  lg:gap-[10px] 
            ...
            <Field type="password" name="resetpass" className=" lg:w-[88%]  lg:h-[50px]  lg:rounded-[10px] 
                                                lg:border-solid lg:border-[1px] lg:border-[black]
                                                sm:border-[1px] sm:border-[black] sm:border-solid
                                                md:border-[1px] md:border-[black] md:border-solid
                                                md:w-[90%]  md:h-[50px]  md:rounded-[10px]
          ...
          <ErrorMessage name="resetpass" component={"p"} className="lg:text-[red]  sm:text-[red] xs:text-[red]" />
