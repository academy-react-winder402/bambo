...
const DetailHeaderContant = () => {
 ...
 md:w-[400px] md:h-[200px] md:m-auto md:flex md:flex-col  md:border-[red] md:border-[1px] md:border-solid
 xs:w-[200px] xs:h-[200px] xs:m-auto xs:flex xs:flex-col
 ">
<div className="lg:w-[220px] lg:h-[180px] lg:ml-[250px] md:border-[red] md:border-[1px] md:border-solid
