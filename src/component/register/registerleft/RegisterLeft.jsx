         ...
         ">
           ...
           xs:h-[100px] xs:w-[350px] xs:flex xs:flex-row-reverse xs:justify-start xs:gap-[10px]
            ...
            "
                ...
                <NavLink to="/login" className="lg:h-[60px] lg:ml-[180px] lg:text-center lg:leading-[45px] lg:w-[90px] lg:bg-[#edeaea] lg:my-[5px]  lg:rounded-xl lg:hover:bg-[#004458] lg:hover:text-[#ffff]
                 sm:ml-[180px] sm:text-center sm:leading-[45px] sm:h-[50px] sm:w-[70px] sm:bg-[#edeaea]  sm:my-[5px]  sm:rounded-xl sm:hover:bg-[#004458] sm:hover:text-[#ffff]
                 xs:ml-[80px] xs:text-center xs:leading-[45px] xs:h-[50px] xs:w-[70px] xs:bg-[#edeaea]  xs:my-[5px]  xs:rounded-xl xs:hover:bg-[#004458] xs:hover:text-[#ffff]">ورود</NavLink>
            </div>
