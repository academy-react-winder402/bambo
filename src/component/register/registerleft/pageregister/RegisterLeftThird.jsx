    ...
    <div>
      ...
      >
        <Form>
          <div
            dir="rtl"
            className=" lg:h-[100px]  lg:flex lg:flex-col lg:gap-[10px] lg:mt-[30px] 
          ...
          >
            ...
            <Field
              ...
              name="pass"
              className=" lg:w-[90%]  lg:h-[40px]  lg:rounded-[10px] lg:pr-[1rem] 
                                                lg:border-solid lg:border-[1px] lg:border-[black]
                                                sm:border-[1px] sm:border-[black] sm:border-solid
                                                md:border-[1px] md:border-[black] md:border-solid
                                                md:w-[90%]  md:h-[50px]  md:rounded-[10px]
            ...
            <i
              className="lg:absolute top-[440px] left-[240px]"
