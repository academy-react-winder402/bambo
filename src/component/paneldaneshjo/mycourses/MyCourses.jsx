   ...
   sm:pt-[30px] 
    ">دوره های من</div>
            <div className=" lg:w-[90%] lg:m-auto  lg:text-[#088568] md:w-[90%] md:m-auto md:text-[#088568] sm:w-[90%] sm:m-auto sm:text-[#088568]">
                ...
                ">
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]">عکس دوره</div>
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]">نام دوره</div>
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]">مدرس</div>
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]">ظرفیت</div>
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]"> تاریخ شروع</div>
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%]">قیمت</div>
                </div>
                <div className="lg:w-[100%] lg:bg-[#F1F1F1] md:w-[100%] md:bg-[#F1F1F1] sm:w-[100%] sm:bg-[#F1F1F1]">
