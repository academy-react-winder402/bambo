...
<div className="lg:w-[98%] lg:h-[60px] lg:border-b-[1px] lg:border-b-[#088568] lg:border-b-solid lg:m-auto lg:flex
                    ...
                    ">
                    <div className="lg:w-[16%] lg:h-[100%] md:w-[16%] md:h-[100%] sm:w-[16%] sm:h-[100%] xs:w-[16%] xs:h-[100%]"><img src={payton} className="w-[40px] h-[40px] m-auto mt-[10px]"></img></div>
                    ...
                    <div className="lg:w-[5%] lg:h-[100%] md:w-[5%] md:h-[100%] sm:w-[5%] sm:h-[100%] xs:w-[5%] xs:h-[100%]"><img src={del} className="w-[80%] h-[30px] m-auto mt-[10px]"></img></div>
                    </div>
    )
}
export {Card};