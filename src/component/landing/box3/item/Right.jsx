...
const Right = () => {
    return (
        <div className="border-b border-solid border-[#D1D1D1] border-r h-[37rem] w-[37rem] relative ">
            <div className=" h-[5rem] w-[25rem] m-auto mt-[9rem] text-4xl text-right dark:text-white">
                دوره های اموزشی
            </div>
            <div className="dark:text-white h-[10rem] w-[25rem] text-xl  text-right m-auto ">
