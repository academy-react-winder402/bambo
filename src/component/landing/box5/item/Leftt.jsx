...
const Leftt = () => {
    return (
        ...
        <div className="border-b border-solid border-[#D1D1D1] border-l h-[35rem] w-[38rem] relative  ">
            <div className=" h-[5rem] w-[25rem] m-auto mt-[7rem] text-5xl text-right dark:text-white ">
                اخبار و مقالات
            </div>
            <div className=" dark:text-white h-[10rem] w-[30rem] text-2xl  text-right m-auto mt-[1rem] ">
