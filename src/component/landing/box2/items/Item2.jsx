    ...
    return (
        <div className="h-72 w-[32rem] inline-block">
            ...
            <div className=" h-16 w-52 m-auto mt-6 flex">
                ...
                <div className=" h-14 w-24 text-white text-4xl text-center"> {courselanding.teacherCount} </div>
            </div>
            <div className=" h-20 w-[23rem] m-auto  text-white text-center text-lg "> بیش از ۳۰ استاد از بهترین اساتید
