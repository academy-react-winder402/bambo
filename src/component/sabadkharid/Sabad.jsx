...
import addsabad from '../../assets/img/sabadkharid/addsabad.png';
            ...
            <div className="border border-solid border-transparent h-[40rem] bg-[#ededed]">
                ...
                <div className="border border-solid border-transparent h-[30rem] w-[57rem] bg-[#fff] m-auto mt-[5rem]">
                    ...
                    <div dir="rtl" className=" h-[2rem]  mt-[2rem] mr-[2.5rem]">
                        <span className={sabad === 1 ? " pl-[0.3rem] pr-[0.2rem] pb-[0.5rem] border-b-4 border-solid  border-[#004458] hover:cursor-pointer text-[#004458]"
                            : " pl-[0.3rem] pr-[0.2rem] pb-[0.5rem] text-[#404040] hover:border-b-4 hover:border-solid  hover:border-[#004458] hover cursor-pointer hover:text-[#004458]"} onClick={() => { updatesabad(1) }}> سبد خرید </span>
                        <span className={sabad === 2 ? "pl-[0.5rem] pr-[0.5rem] pb-[0.5rem]  border-b-4  border-solid  border-[#004458] hover:cursor-pointer text-[#004458]" 
                        : "pl-[0.5rem] pr-[0.5rem] pb-[0.5rem] text-[#404040] hover:border-b-4 hover:border-solid  hover:border-[#004458] hover:cursor-pointer hover:text-[#004458]"} onClick={() => { updatesabad(2) }}> خرید بعدی </span>
                    </div>
                    ...
                    <div className="w-[90%] m-auto h-[18rem] mt-[2rem]">
                        ...
                        <div className={sabad === 1 ? "border border-solid border-transparent h-[15rem] bg-[#F1F1F1] " : "hidden"}>
                        ...
                        <div className={sabad === 2 ? "border border-solid border-transparent h-[15rem] bg-[#F1F1F1] " : "hidden"}>
                            <div dir="rtl" className="border-b-2 border-solid border-[#0885688a] h-[5rem] w-[95%] m-auto flex gap-[3rem] text-[#004458]">
                                <div className=" h-[4rem] w-[4rem] mt-[0.4rem] mr-[1.5rem]
                                 bg-[url('././assets/img/courses/js.png')] bg-no-repeat bg-cover"> </div>
                                <span className="block mr-[1.5rem] mt-[1.5rem]"> جاوا </span>
                                ...
                                <span className="block mt-[1.6rem] mr-[1rem]"> 200000 </span>
                                <div className=" h-[2rem] w-[1.7rem] mt-[1.3rem] mr-[1rem]">
                                    <img src={addsabad} className="h-[1.5rem] w-[1.7rem]" />
                                </div>
                            </div>
